...
public class AchievementIniParserTest {
    ...
    public void testParseReturnsAchievementDefinitionWhenIniFileIsGiven() throws Exception {
        ...
        assertThat(simple.get().getSubscriptions(), is(equalTo(Collections.<String>emptyList())));
        ...
        assertThat(first.getSubscriptions().size(), is(equalTo(1)));
        assertThat(first.getSubscriptions().get(0), is("sample"));
        ...
        assertThat(date.getSubscriptions().get(0), is("sample"));
        ...
        assertThat(time.getSubscriptions().size(), is(equalTo(1)));
        assertThat(time.getSubscriptions().get(0), is("sample"));
        ...
        assertThat(timeRange.getSubscriptions().get(0), is("sample2"));
        ...
        assertThat(composite1.getSubscriptions().size(), is(equalTo(1)));
        assertThat(composite1.getSubscriptions().get(0), is("sample2"));
        ...
        assertThat(composite2.getSubscriptions().size(), is(equalTo(1)));
        assertThat(composite2.getSubscriptions().get(0), is("sample2"));
    }
}
